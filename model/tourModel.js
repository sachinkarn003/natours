...
const tourSchema = new mongoose.Schema({
  name: {
    type: String,
    required: [true, 'A tour must hava name'],
    unique: true,
    maxlength:[40,'A tour name must have less or equal than 40 character'],
    minlength:[10,'A tour name must have more then 10 or equal to character']
  ...
  summary: {
    type: String,
    trim: true, //e.g "      This is input      "-- covert -> "This is input"
